...
class CIFAR10DataModule(pl.LightningDataModule):
    ...
    def prepare_data(self, stage=None, CIFAR_ROOT="../datasets/cifar10"):
        ...
        # training and validation dataset transform
        ...
        if self.opt['loading_method'] == 'Image':
            ...
            cifar_complete_augmented = torchvision.datasets.ImageFolder(root=CIFAR_ROOT, transform=train_val_transform)
            cifar_test = torchvision.datasets.ImageFolder(root=CIFAR_ROOT, transform=test_transform)
            ...
            _,self.val_dataset,self.test_dataset = \
                random_split(cifar_test,[num_train, num_val, num_test])
