...
def parse_cfg():
    ...
    parser.add_argument('--train-data', type=str, default='data/simulator/train/Dataset4/VehicleData.txt', help='data path')
    parser.add_argument('--val-data', type=str, default='data/simulator/train/Dataset4/VehicleData.txt', help='data path')
